...
/* harmony export */   removeUsersElement: () => (/* binding */ removeUsersElement)
/* harmony export */ });
...
var appendUserList = function (users) {
    var userList = (0,_utils_dom__WEBPACK_IMPORTED_MODULE_0__.getElementById)("user-list");
    users.forEach(function (user) {
        var userElement = (0,_utils_dom__WEBPACK_IMPORTED_MODULE_0__.createElement)("li", " ".concat(user.name, " : ").concat(user.email));
 ...
 * @returns void
 */
var removeUsersElement = function () {
    var _a;
    var userList = (0,_utils_dom__WEBPACK_IMPORTED_MODULE_0__.getElementById)("user-list");
    while (userList.firstChild) {
        (_a = userList.firstChild) === null || _a === void 0 ? void 0 : _a.remove();
    }
};
...
var userButton = (0,_utils_dom__WEBPACK_IMPORTED_MODULE_1__.getElementById)("button-user");
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                users = _a.sent();
                // ユーザー情報の表示
                (0,_user__WEBPACK_IMPORTED_MODULE_0__.removeUsersElement)();
                (0,_user__WEBPACK_IMPORTED_MODULE_0__.appendUserList)(users);
                return [2 /*return*/];
        }
    });
}); });
